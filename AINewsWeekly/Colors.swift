...
extension Color {
    ...
    static let inkCream = Color(uiColor: UIColor { t in
        t.userInterfaceStyle == .dark
            ? UIColor(red: 0.098, green: 0.075, blue: 0.055, alpha: 1) // #191310
            : UIColor(red: 0.973, green: 0.957, blue: 0.925, alpha: 1) // #F8F4EC
    })
    static let inkCard = Color(uiColor: UIColor { t in
        t.userInterfaceStyle == .dark
            ? UIColor(red: 0.129, green: 0.102, blue: 0.082, alpha: 1) // #211A15
            : UIColor(red: 0.984, green: 0.969, blue: 0.937, alpha: 1) // #FBF7EF
    })

    // Text
    static let inkText = Color(uiColor: UIColor { t in
        t.userInterfaceStyle == .dark
            ? UIColor(red: 0.941, green: 0.925, blue: 0.898, alpha: 1) // #F0ECE5
            : UIColor(red: 0.122, green: 0.094, blue: 0.075, alpha: 1) // #1F1813
    })
    ...
    static let inkCodeBg = Color(uiColor: UIColor { t in
        t.userInterfaceStyle == .dark
            ? UIColor(red: 0.165, green: 0.133, blue: 0.102, alpha: 1) // #2A221A
            : UIColor(red: 0.941, green: 0.914, blue: 0.847, alpha: 1) // #F0E9D8
    })
}
